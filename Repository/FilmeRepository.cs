...
namespace dotnet_dapper.Repository
{
    public class FilmeRepository : IFilmeRepository
    {
        ...
        private readonly string conncectionsString;

        public FilmeRepository(IConfiguration configuration)
        {
            _configuration = configuration;
            conncectionsString = _configuration.GetConnectionString("SqlConnection");
        }
        public async Task<IEnumerable<FilmeResponse>> BuscaFilmesAsync()
        {
            ...
            using var con = new SqlConnection(conncectionsString);
        ...
        public async Task<FilmeResponse> BuscaFilmeAsync(int id)
        {
            ...
            using var con = new SqlConnection(conncectionsString);
            return await con.QueryFirstOrDefaultAsync<FilmeResponse>(sql, new { id });
